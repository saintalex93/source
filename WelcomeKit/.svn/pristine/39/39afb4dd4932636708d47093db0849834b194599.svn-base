        ...
        AbstractIntegrationTest
{
    ...
    public void shouldAssertUpdateProductWhenCodeIsDifferenteOfDataBase()
    {
        ...
        given().contentType( ContentType.JSON ).body( json ).when().post( "product/update" ).then().assertThat().statusCode(
            HttpStatus.SC_OK );
    }
    ...
    public void shouldThrowCategoryFillExceptionWhenCategoryNotFillID()
    {
        ...
        final ErrorDetails bodyError = given().contentType( ContentType.JSON ).body( json ).when().post( "product/save" ).then()
            .log().everything()
    ...
    public void shouldThrowProductNotFoundExceptionWhenUpdateProductWithoutID()
    {
        ...
        final ErrorDetails bodyError = given().contentType( ContentType.JSON ).body( json ).when().post( "product/update" ).then()
            .log().everything()
            .assertThat().extract().as( ErrorDetails.class );
    ...
    {
        final ErrorDetails bodyError = given().contentType( ContentType.JSON ).when().get( "product/search/code/13" ).then()
            .log().everything()
            .assertThat().extract().as( ErrorDetails.class );
        assertThat( bodyError.getDetails() ).contains( ProductNotFoundException.class.getName() );
    }
    ...
    {
        final ErrorDetails bodyError = given().contentType( ContentType.JSON ).when().post( "product/delete/12" ).then()
            .log().everything()
            .assertThat().extract().as( ErrorDetails.class );
        assertThat( bodyError.getDetails() ).contains( ProductNotFoundException.class.getName() );
    }
    ...
    public void shouldAssertWhenProductWithoutStockIsDeleted()
    {
        ...
        given().contentType( ContentType.JSON ).when().post( "product/delete/" + product.getId() ).then().assertThat().statusCode(
            HttpStatus.SC_OK );
    ...
    public void shouldAssertWhenProductWithStockIsDeleted()
    {
        ...
        given().contentType( ContentType.JSON ).body( "{\"idProduct\":" + product.getId() + ",\"quantity\":1}" ).when().post(
            "stock/create" );
    ...
    {
        final ErrorDetails bodyError = given().contentType( ContentType.JSON ).when().post( "product/delete/2" ).then()
            .log().everything()
            .assertThat().extract().as( ErrorDetails.class );
    ...
    {
        final Product[] productDB = given().contentType( ContentType.JSON ).when().get( "product/search/category/13" )
            .as( Product[].class );
        assertThat( productDB != null );
