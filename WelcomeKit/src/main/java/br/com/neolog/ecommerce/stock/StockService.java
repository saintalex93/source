...
public class StockService
{
    ...
    {
        final int idStock = stockItem.getIdProduct();
        if( repository.findByProductId( idStock ) != null ) {
        ...
        final StockItem stockItem )
    {
        ...
        final long quantitySum = 0l + stockItem.getQuantity() + objStock.getQuantity();
        ...
        final int idStock )
    {
        ...
        final Stock stock = repository.findById( idStock );
